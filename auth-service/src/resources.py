    ...
    def post():
        try:
            ...
            try:
                ...
                logging.send_log_kafka('INFO', __module_name__, 'UsersResource.post',
                                       f'User {user.uuid} created successfully')
    ...
    def patch(user_uuid):
        try:
            ...
            try:
                ...
                logging.send_log_kafka('INFO', __module_name__, 'UserResource.patch',
                                       f'User {user_uuid} updated successfully')
            except Exception as e:
    ...
    def delete(user_uuid):
        try:
            ...
            try:
                ...
                logging.send_log_kafka('INFO', __module_name__, 'UserResource.delete',
                                       f'User {user_uuid} deleted successfully')
            except Exception as e:
    ...
    def post():
        try:
            ...
            token = token_provider.create_token(payload={'email': user.email,
                                                         'url_redirect_success': data['url_redirect_success'],
                                                         'url_redirect_fail': data['url_redirect_fail']})
            ...
            Thread(target=kafka.kafka_producer,
                   args=(config_env('TOPIC_SEND_EMAIL_VALIDATION'), user.uuid, payload,)).start()

            logging.send_log_kafka('INFO', __module_name__, 'SendEmailValidationResource.post',
                                   f'Email sent topic {config_env("TOPIC_SEND_EMAIL_VALIDATION")}')
